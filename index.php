...
//         $searchCard = new SearchCard($pokemonName);
//         $rep = $searchCard->search();
//     }
// }
...
<html lang="pt-br">
    ...
    <body id="page-top">
        <nav class="navbar navbar-expand-lg bg-secondary fixed-top" id="mainNav">
            <div class="container"><a class="navbar-brand js-scroll-trigger" href="#page-top">POKEMON TCG</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading mb-0">POKEMON TCG</h1>
                <!-- Icon Divider-->
        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <form enctype="multipart/form-data" action="./parametro.php" method="post">
                    <div class="text-center">
                        <input type="text" name="pokemonName" placeholder="Nome do Pokémon">
                        <input class="text-secondary mb-0 d-inline-block"  name="pokemonName"type="submit" value="darkrai">
                    </div>
                </form>
                <!-- Icon Divider-->
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal0">
                            ...
                            </div><img class="img-fluid" src="<?php echo $imageUrl; ?>" alt="Imagem do Pokémon"/>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal0">
                            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                                <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
                            </div><img class="img-fluid" src="<?php echo $imageUrl2; ?>" alt="Imagem do Pokémon"/>
                        </div>
                    </div>
                    <div class="row justify-content-center">
    <?php
    if (isset($_GET['rep'])) {
        $rep = json_decode($_GET['rep'], true);
        foreach ($rep as $aa) :
    ?>
            <div class="col-md-6 col-lg-4 mb-5">
                <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal0">
                    ...
                    <img class="img-fluid" src="<?= $aa; ?>" alt="Imagem do Pokémon" />
                </div>
            </div>
    <?php
        endforeach;
